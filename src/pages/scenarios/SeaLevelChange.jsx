...
class SeaLevelChange extends Component {
    constructor(props) {
        super(props);
        this.state = {seaLevel: "", seaLevelChanged: null, seaLevels:[]};
    }
    ...
    handleSubmit = (event) => {
        ...
        .then(result => { alert("Evaluated Successfully"); this.setState({seaLevelChanged: this.state.seaLevel}); this.forceUpdate(); } )
    }
    ...
    return (
        <form>
            <Grid container spacing={2}>
                ...
                <Grid item lg={12}>
                    <div >
                        <ClimateImpact showImpact = {this.state.seaLevelChanged}></ClimateImpact>
                    </div>
                </Grid>
            </Grid>
        </form>
